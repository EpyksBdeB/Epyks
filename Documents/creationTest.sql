...
-- Schema epyks
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `epyks_test` DEFAULT CHARACTER SET utf8 ;
USE `epyks_test` ;

-- -----------------------------------------------------
-- Table `epyks_test`.`utilisateur`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `epyks_test`.`utilisateur` (
...
-- -----------------------------------------------------
-- Table `epyks_test`.`contact`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `epyks_test`.`contact` (
  ...
  CONSTRAINT `fk_id_utilisateur`
    ...
    REFERENCES `epyks_test`.`utilisateur` (`id_utilisateur`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
